...
const values = [
  {
    ...
    title: "Innovación",
    description:
      "Desarrollamos soluciones tecnológicas de vanguardia para revolucionar la gestión de inventarios.",
  },
  {
    icon: Shield,
    title: "Confiabilidad",
    description:
      "Garantizamos sistemas robustos y seguros que funcionan 24/7 sin comprometer la operación.",
  },
  {
    icon: Zap,
    title: "Eficiencia",
    description:
      "Optimizamos procesos para maximizar la productividad y minimizar costos operativos.",
  },
  {
    icon: Heart,
    title: "Compromiso",
    description:
      "Nos dedicamos completamente al éxito de nuestros clientes con soporte continuo y personalizado.",
  },
];
      ...
      <div className="container mx-auto px-6">
        ...
        <div className="text-center mb-16 fade-in-up">
          ...
          <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
            ...
            comprometidos con el futuro de la gestión inteligente de
            inventarios.
          </p>
        </div>
        ...
        <div className="grid lg:grid-cols-2 gap-12 mb-20">
          ...
          <Card className="corporate-card group fade-in-up">
            ...
            <CardContent>
              <p className="text-muted-foreground leading-relaxed text-lg">
                Transformar la gestión de inventarios a través de tecnología
                inteligente y automatización, proporcionando a las empresas
                herramientas innovadoras que optimicen sus operaciones, reduzcan
                costos y mejoren la toma de decisiones estratégicas en tiempo
                real.
              </p>
            </CardContent>
          </Card>
          ...
          {/* Vision */}
          <Card
            className="corporate-card group fade-in-up"
          ...
          >
            ...
            <CardContent>
              <p className="text-muted-foreground leading-relaxed text-lg">
                Ser la empresa líder en soluciones de inventario inteligente en
                México y Latinoamérica, reconocida por nuestra innovación
                tecnológica, excelencia en el servicio y por democratizar el
                acceso a herramientas de gestión avanzada para empresas de todos
                los tamaños.
              </p>
            </CardContent>
          </Card>
