  ...
  return (
    <section className="min-h-screen bg-gradient-to-br from-background via-background to-primary/5 relative overflow-hidden pt-16">
      ...
      <div className="absolute inset-0">
        ...
        <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-[600px] h-[400px] bg-secondary/5 rounded-full blur-3xl animate-pulse" style={{ animationDelay: '2s' }}></div>
      </div>
          ...
          <div className="space-y-8 fade-in-up">
            <div className="space-y-6">
              ...
              <p className="text-xl text-muted-foreground max-w-lg leading-relaxed">
                Revoluciona tu almacén con tecnología de vanguardia. 
                Control en tiempo real, IA predictiva y automatización total.
              </p>
            </div>
            
            <div className="flex flex-col sm:flex-row gap-4">
              <Button size="lg" className="corporate-button-primary group px-8 py-4 text-lg">
                Descubrir Sistema Avanzado
                <ArrowRight className="w-5 h-5 ml-2 group-hover:translate-x-1 transition-transform" />
              </Button>
              <Button variant="outline" size="lg" className="corporate-button-outline px-8 py-4 text-lg">
            ...
            <div className="flex items-center gap-8 pt-8">
              ...
              <div className="w-px h-12 bg-border"></div>
              <div className="text-center">
                <div className="text-3xl font-bold text-secondary font-heading">-85%</div>
